      ...
      <section className="max-w-[1080px] mx-auto px-6 py-16 md:py-20">
        <div className="max-w-3xl space-y-16">
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                {
                  name: "RevenueCat",
                  role: "Subscription management. Handles subscription status and entitlements for in-app purchases made through Apple and Google.",
                },
                {
                  name: "ConvertKit",
          ...
          <div>
            ...
            <p className="text-dim leading-relaxed mb-4">
              Prova offers premium features through subscription plans.
              Subscriptions are handled entirely via Apple App Store or Google
              Play Store in-app purchases, managed through RevenueCat.
            </p>
            <div className="bg-card border border-border rounded-2xl p-6">
              <p className="text-secondary font-semibold mb-2">
                Payment Security:
              ...
              <p className="text-dim leading-relaxed">
                We do <strong className="text-secondary">not</strong> collect,
                process, or store your payment card details or financial
                information. All payment transactions are handled securely by
                Apple or Google through their respective app store platforms.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-dim leading-relaxed">
              ...
              information promptly. If you believe that a child under 18 has
          ...
          <div>
            <h2 className="text-2xl font-bold text-secondary tracking-tight mb-4">
              <span className="font-mono text-accent mr-2">12.</span>
              Contact Us
            </h2>
            <p className="text-dim leading-relaxed mb-4">
